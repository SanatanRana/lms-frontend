  ...
  return (
    <div className={`w-full flex flex-col ${wrapperClassName}`}>
      ...
      <select
        ref={ref}
        id={selectId}
        className={`block w-full bg-card border text-white rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition duration-150 ${
